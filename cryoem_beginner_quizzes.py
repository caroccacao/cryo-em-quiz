...
def phase_quiz():
    ...
    selected_quiz = st.sidebar.selectbox("Select Quiz", ["Phase Contrast", "Getting Started"])
    
    if selected_quiz == "Phase Contrast":
        for q in questions:
    ...
    elif selected_quiz == "Another Quiz":
        st.write("Another quiz will be implemented here.")
